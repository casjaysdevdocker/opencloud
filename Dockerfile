# Docker image for opencloud using the debian template
...
LABEL org.opencontainers.image.url="docker.io/casjaysdevdocker/opencloud"
LABEL org.opencontainers.image.source="docker.io/casjaysdevdocker/opencloud"
