# Docker image for opencloud using the alpine template
ARG IMAGE_NAME="opencloud"
ARG PHP_SERVER="opencloud"
ARG BUILD_DATE="202511211505"
...
ARG IMAGE_REPO="casjaysdevdocker/opencloud"
...
ARG PACK_LIST="ca-certificates curl wget bash tini gnupg apt-transport-https tzdata procps netcat-openbsd nginx default-jre-headless python3 python3-pip python3-venv clamav clamav-daemon clamav-freshclam "
...
ENV HOSTNAME="casjaysdevdocker-opencloud"
...
LABEL org.opencontainers.image.url="https://docker.io/casjaysdevdocker/opencloud"
LABEL org.opencontainers.image.source="https://docker.io/casjaysdevdocker/opencloud"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.revision="${GIT_COMMIT}"
LABEL org.opencontainers.image.source="https://github.com/casjaysdevdocker/opencloud"
LABEL org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/opencloud"
